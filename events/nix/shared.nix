rec {
  shellHook-for =
    ...
    in ''
      ...
      echo -e " \033[32m|_|\033[37mA\033[31mR\033[36mD\033[32m |___/                 \033[33mEVENTS                 \033[37mhttps://patreon.com/rydnr\033[0m";
      echo;
      echo " Thank you for using pythoneda-realm-rydnr/events, and for your appreciation of free software.";
      echo;
